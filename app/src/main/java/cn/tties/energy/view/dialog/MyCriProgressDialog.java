 ...
 * author chensi
 */
public class MyCriProgressDialog {
    private Context mContext;
    private Dialog mDialog;
    private TextView text;

    public MyCriProgressDialog() {
        mContext = MyApplication.getInstance();
    }

    public MyCriProgressDialog(Context context) {
        mContext = context;
    }
...
//        viewDialog.setBackgroundColor(0x7f000000);
        ...
        if (!StringUtil.isEmpty(str)) {
            text = (TextView) viewDialog.findViewById(R.id.mytextView);
            text.setText(str);
        }
