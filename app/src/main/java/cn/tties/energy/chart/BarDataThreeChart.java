...
public class BarDataThreeChart extends BarChart {
    public BarDataThreeChart(Context context) {
        super(context);
        setStyle();
    }
    ...
    public BarDataThreeChart(Context context, AttributeSet attrs) {
        super(context, attrs);
        setStyle();
    }

    public BarDataThreeChart(Context context, AttributeSet attrs, int defStyle) {
